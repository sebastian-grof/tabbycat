...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("actionlog", "0014_alter_actionlogentry_type"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("qu.crea", "Created question"),
                    ("qu.edit", "Edited question"),
                    ("inst.reg", "Registered institution"),
                    ("te.reg", "Registered team"),
                    ("aj.reg", "Registered adjudicator"),
                    ("sp.reg", "Registered speaker"),
                    ("re.conf", "Confirmed registration"),
                    ("te.del", "Deleted team"),
                    ("aj.del", "Deleted adjudicator"),
                    ("sc.crea", "Created schedule event"),
