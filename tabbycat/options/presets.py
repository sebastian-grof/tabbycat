...
class WSDCPreferences(AustralsPreferences):
    ...
    # Speech types are ScoreCriterion.SpeechType values, spelled out here because
    # results.models can't be imported at module level (circular import).
    score_criteria = (
        ('Style', 'substantive', Decimal('24'), Decimal('32'), True),
        ('Content', 'substantive', Decimal('24'), Decimal('32'), True),
        ('Strategy', 'substantive', Decimal('12'), Decimal('16'), True),
        ('POIs', 'substantive', Decimal('-2'), Decimal('2'), False),
        ('Style', 'reply', Decimal('12'), Decimal('16'), True),
        ('Content', 'reply', Decimal('12'), Decimal('16'), True),
        ('Strategy', 'reply', Decimal('6'), Decimal('8'), True),
    )
