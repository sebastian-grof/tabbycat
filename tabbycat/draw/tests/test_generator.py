...
class TestRandomDrawGenerator(unittest.TestCase):
    ...
    def test_draw(self):
        for i in range(100):
            teams = [TestTeam(*args, side_history=[0, 0]) for args in self.teams]
            self.rd = DrawGenerator(2, "random", teams, None, avoid_conflicts="on")
...
class TestPowerPairedDrawGeneratorParts(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ppd = DrawGenerator(2, "power_paired", DUMMY_TEAMS, None)
...
class TestPowerPairedDrawGenerator(unittest.TestCase):
    ...
    def do_draw(self, standings, options):
        ...
        self.ppd = DrawGenerator(2, "power_paired", standings, None, **options)
...
class TestPowerPairedWithAllocatedSidesDrawGeneratorPartOddBrackets(unittest.TestCase):
    ...
    brackets[2] = OrderedDict([
        (5, [[], [16, 17]]),
        (4, [[1, 2, 3, 4], [18, 19, 20, 21]]),
        (3, [[5, 6, 7], [22, 23]]),
        (2, [[8, 9, 10], []]),
        (1, [[11, 12, 13, 14], [24, 25, 26, 27]]),
        (0, [[15], [28, 29, 30]]),
    ])
    brackets[3] = OrderedDict([
        (5, [[1, 2], []]),
        (4, [[3, 4], [13]]),
        (3, [[5, 6, 7, 8, 9], [14, 15, 16]]),
        (2, [[], [17, 18, 19]]),
        (1, [[10, 11], [20, 21, 22, 23, 24]]),
        (0, [[12], []]),
    ])
    brackets[4] = OrderedDict([
        (3, [["Yale 2", "Stanford 2", "Yale 1"], []]),
        (2, [["John Hopkins 1", "Stanford 1", "MIT 1", "Stanford 3", "Berkeley 1"], ["MIT 2", "Columbia 1", "Caltech 1", "Caltech 3"]]),  # noqa: E501
        (1, [["Caltech 2", "Cornell 1", "Yale 3", "Princeton 1"], ["Chicago 2", "Chicago 1", "Pennsylvania 1", "Chicago 3", "Princeton 2"]]),  # noqa: E501
        (0, [[], ["Pennsylvania 2", "Harvard 1", "Harvard 2"]]),
    ])
    ...
    expecteds["pullup_top"][2] = OrderedDict([
        (5, [[1, 2], [16, 17]]),
        (4, [[3, 4, 5, 6], [18, 19, 20, 21]]),
        (3, [[7, 8], [22, 23]]),
        (2, [[9, 10], [24, 25]]),
        (1, [[11, 12, 13, 14], [26, 27, 28, 29]]),
        (0, [[15], [30]]),
    ])
    expecteds["pullup_top"][3] = OrderedDict([
        (5, [[1, 2], [13, 14]]),
        (4, [[3, 4], [15, 16]]),
        (3, [[5, 6, 7, 8, 9], [17, 18, 19, 20, 21]]),
        (2, [[], []]),
        (1, [[10, 11, 12], [22, 23, 24]]),
        (0, [[], []]),
    ])
    expecteds["pullup_top"][4] = OrderedDict([
        (3, [["Yale 2", "Stanford 2", "Yale 1"], ["MIT 2", "Columbia 1", "Caltech 1"]]),
        (2, [["John Hopkins 1", "Stanford 1", "MIT 1", "Stanford 3", "Berkeley 1"], ["Caltech 3", "Chicago 2", "Chicago 1", "Pennsylvania 1", "Chicago 3"]]),  # noqa: E501
        (1, [["Caltech 2", "Cornell 1", "Yale 3", "Princeton 1"], ["Princeton 2", "Pennsylvania 2", "Harvard 1", "Harvard 2"]]),  # noqa: E501
        (0, [[], []]),
    ])
    ...
    expecteds["pullup_bottom"][2] = OrderedDict([
        (5, [[3, 4], [16, 17]]),
        (4, [[1, 2, 6, 7], [18, 19, 20, 21]]),
        (3, [[5, 10], [22, 23]]),
        (2, [[8, 9], [26, 27]]),
        (1, [[11, 12, 13, 14], [24, 25, 29, 30]]),
        (0, [[15], [28]]),
    ])
    expecteds["pullup_bottom"][3] = OrderedDict([
        (5, [[1, 2], [13, 16]]),
        (4, [[3, 4], [14, 15]]),
        (3, [[5, 6, 7, 8, 9], [17, 18, 19, 23, 24]]),
        (2, [[], []]),
        (1, [[10, 11, 12], [20, 21, 22]]),
        (0, [[], []]),
    ])
    expecteds["pullup_bottom"][4] = OrderedDict([
        (3, [["Yale 2", "Stanford 2", "Yale 1"], ["Columbia 1", "Caltech 1", "Caltech 3"]]),
        (2, [["John Hopkins 1", "Stanford 1", "MIT 1", "Stanford 3", "Berkeley 1"], ["MIT 2", "Chicago 1", "Pennsylvania 1", "Chicago 3", "Princeton 2"]]),  # noqa: E501
        (1, [["Caltech 2", "Cornell 1", "Yale 3", "Princeton 1"], ["Chicago 2", "Pennsylvania 2", "Harvard 1", "Harvard 2"]]),  # noqa: E501
        (0, [[], []]),
    ])
    ...
    expecteds["intermediate1"][4] = OrderedDict([
        (3,   [[], []]),
        (2.5, [["Yale 2", "Stanford 2", "Yale 1"], ["MIT 2", "Columbia 1", "Caltech 1"]]),
        (2,   [["John Hopkins 1"], ["Caltech 3"]]),
        (1.5, [["Stanford 1", "MIT 1", "Stanford 3", "Berkeley 1"], ["Chicago 2", "Chicago 1", "Pennsylvania 1", "Chicago 3"]]),
        (1,   [["Caltech 2"], ["Princeton 2"]]),
        (0.5, [["Cornell 1", "Yale 3", "Princeton 1"], ["Pennsylvania 2", "Harvard 1", "Harvard 2"]]),
        (0,   [[], []]),
    ])
        ...
        for method, expected_results in self.expecteds.items():
            for index, expected in expected_results.items():
                with self.subTest(method=method, index=index):
                    ppd = DrawGenerator(2, "power_paired", DUMMY_TEAMS, None, side_allocations="preallocated", odd_bracket=method)
    ...
    def test_pullup_random(self):
        for j in range(10):
            ...
            ppd = DrawGenerator(2, "power_paired", DUMMY_TEAMS, None, side_allocations="preallocated", odd_bracket="pullup_random")
            ppd.resolve_odd_brackets(b2)

            self.assertEqual(b2[5][DebateSide.AFF], [1, 2])
            self.assertIn(13, b2[5][DebateSide.NEG])
            self.assertEqual([i in b2[5][DebateSide.NEG] for i in [14, 15, 16]].count(True), 1)
            self.assertEqual(b2[4][DebateSide.AFF], [3, 4])
            self.assertEqual([i in b2[4][DebateSide.NEG] for i in [14, 15, 16]].count(True), 2)
            self.assertCountEqual(b2[5][DebateSide.NEG] + b2[4][DebateSide.NEG], [13, 14, 15, 16])
            self.assertEqual(b2[3][DebateSide.AFF], [5, 6, 7, 8, 9])
            self.assertTrue(all(i in b2[3][DebateSide.NEG] for i in [17, 18, 19]))
            self.assertEqual([i in b2[3][DebateSide.NEG] for i in [20, 21, 22, 23, 24]].count(True), 2)
            self.assertEqual(b2[2], [[], []])
            self.assertEqual(b2[1][DebateSide.AFF], [10, 11, 12])
            self.assertEqual([i in b2[1][DebateSide.NEG] for i in [20, 21, 22, 23, 24]].count(True), 3)
            self.assertEqual(b2[0], [[], []])

    def test_middle_bye_preallocated_single_bracket_uses_fold_leftover(self):
        teams = [
    ...
    def test_middle_bye_without_preallocations_uses_fold_leftover(self):
        teams = [
            TestTeam(1, 'A', 3),
            TestTeam(2, 'B', 3),
            TestTeam(3, 'C', 3),
    ...
    def test_middle_bye_preallocated_uses_ordered_fold_leftover(self):
        teams = [
            TestTeam(1, 'A', 4, allocated_side=DebateSide.NEG),
            TestTeam(2, 'B', 4, allocated_side=DebateSide.AFF),
            TestTeam(3, 'C', 4, allocated_side=DebateSide.AFF),
            TestTeam(4, 'D', 4, allocated_side=DebateSide.NEG),
            TestTeam(5, 'E', 4, allocated_side=DebateSide.AFF),
            TestTeam(6, 'F', 3, allocated_side=DebateSide.NEG),
            TestTeam(7, 'G', 3, allocated_side=DebateSide.NEG),
            TestTeam(8, 'H', 3, allocated_side=DebateSide.AFF),
            TestTeam(9, 'I', 3, allocated_side=DebateSide.AFF),
        ]
...
class TestPartialEliminationDrawGenerator(BaseTestEliminationDrawGenerator):
    ...
    def run_draw(self, break_size, expected):
        ...
        self.fed = DrawGenerator(2, "first_elimination", teams)
...
class TestEliminationDrawGenerator(BaseTestEliminationDrawGenerator):
    ...
    def test_error(self):
        ...
        self.ed = DrawGenerator(2, "elimination", teams, results=results)
