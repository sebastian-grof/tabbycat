...
urlpatterns = [
    path('institutions/', include([
        ...
        path('email/', views.EmailInstitutionCoachesView.as_view(), name='reg-email-coaches'),
    ...
    path('teams/', include([
        ...
        path('<int:pk>/delete/', views.DeleteTeamRegistrationView.as_view(), name='reg-team-delete'),
        path('questions/',
    ...
    path('adjudicators/', include([
        ...
        path('<int:pk>/delete/', views.DeleteAdjudicatorRegistrationView.as_view(), name='reg-adjudicator-delete'),
        path('questions/',
