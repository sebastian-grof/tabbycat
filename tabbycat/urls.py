...
urlpatterns = [
    ...
    path('site-tools/',
        tournaments.views.SiteToolsView.as_view(),
        name='site-tools'),
    path('categories/manage/',
        tournaments.views.TournamentCategoryManageView.as_view(),
        name='tournament-category-manage'),
    path('categories/api/save/',
        tournaments.views.TournamentCategoryLayoutSaveView.as_view(),
        name='tournament-category-layout-save'),
    path('categories/<slug:category_slug>/',
        tournaments.views.TournamentCategoryLandingView.as_view(),
