...
def env_bool(name, fallback='0'):
    return str(os.environ.get(name, fallback)).strip().lower() in {'1', 'true', 'yes', 'on'}


FEEDBACK_EXPORT_ENABLED = env_bool(
    'SDA_JUDGES_FEEDBACK_EXPORT_ENABLED',
    os.environ.get('FEEDBACK_EXPORT_ENABLED', '0'),
)
FEEDBACK_EXPORT_ENDPOINT = os.environ.get(
    'SDA_JUDGES_FEEDBACK_API_URL',
    os.environ.get('FEEDBACK_EXPORT_ENDPOINT', ''),
)
FEEDBACK_EXPORT_TOKEN = os.environ.get(
    'SDA_JUDGES_FEEDBACK_API_TOKEN',
    os.environ.get('FEEDBACK_EXPORT_TOKEN', ''),
)
FEEDBACK_EXPORT_TIMEOUT = int(os.environ.get('FEEDBACK_EXPORT_TIMEOUT', '10'))

ADJUDICATOR_STATS_EXPORT_ENABLED = env_bool(
    'SDA_JUDGES_ACTIVITY_EXPORT_ENABLED',
    os.environ.get('ADJUDICATOR_STATS_EXPORT_ENABLED', '0'),
)
ADJUDICATOR_STATS_EXPORT_ENDPOINT = os.environ.get(
    'SDA_JUDGES_ACTIVITY_API_URL',
    os.environ.get('ADJUDICATOR_STATS_EXPORT_ENDPOINT', ''),
)
ADJUDICATOR_STATS_EXPORT_TOKEN = os.environ.get(
    'SDA_JUDGES_ACTIVITY_API_TOKEN',
    os.environ.get('ADJUDICATOR_STATS_EXPORT_TOKEN', FEEDBACK_EXPORT_TOKEN),
)
ADJUDICATOR_STATS_EXPORT_TIMEOUT = int(os.environ.get(
    'ADJUDICATOR_STATS_EXPORT_TIMEOUT',
    os.environ.get('FEEDBACK_EXPORT_TIMEOUT', '10'),
))
