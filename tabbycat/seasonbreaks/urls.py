...
urlpatterns = [
    ...
    path('<slug:season_slug>/identities/speakers/', views.SeasonSpeakerIdentitiesView.as_view(), name='seasonbreaks-identities-speakers'),
    path('<slug:season_slug>/identities/adjudicators/', views.SeasonAdjudicatorIdentitiesView.as_view(), name='seasonbreaks-identities-adjudicators'),
    ...
    path('<slug:season_slug>/rankings/global/',
        views.SeasonGlobalRankingView.as_view(),
        name='seasonbreaks-global-ranking'),
